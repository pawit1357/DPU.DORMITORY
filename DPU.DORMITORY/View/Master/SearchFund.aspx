<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="SearchFund.aspx.cs" Inherits="DPU.DORMITORY.Web.View.Master.SearchFund" %>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box blue-madison">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-cogs"></i>ประเภทเนื้อชาติ
                        </div>
                        <div class="actions">
                    ...
                    <div class="portlet-body">
                        <asp:GridView ID="gvResult" runat="server" AutoGenerateColumns="False"
                            CssClass="table table-striped table-hover table-bordered" ShowHeaderWhenEmpty="True" DataKeyNames="ID" OnRowCommand="gvResult_RowCommand" OnRowDeleting="gvResult_RowDeleting" OnPageIndexChanging="gvResult_PageIndexChanging" OnRowDataBound="gvResult_RowDataBound">
                            <Columns>
                                <asp:BoundField HeaderText="รหัส" DataField="ID" ItemStyle-HorizontalAlign="Left" SortExpression="ID" />
                                <asp:TemplateField HeaderText="สำหรับ" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:Literal ID="litServiceFor" runat="server" Text='<%# Eval("FOR_SERVICE_ID")%>' />
                                    </ItemTemplate>
