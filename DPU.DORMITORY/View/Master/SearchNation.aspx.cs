...
{
    public partial class SearchNation : System.Web.UI.Page
    {

        private UnitOfWork unitOfWork = new UnitOfWork();
        private Repository<TB_M_NATION> rep;

        public SearchNation()
        {
            rep = unitOfWork.Repository<TB_M_NATION>();
        }
        ...
        protected void lbAdd_Click(object sender, EventArgs e)
        {
            ...
            Server.Transfer(Constants.LINK_NATION);
        }
