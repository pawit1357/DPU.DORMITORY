                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group" style="text-align: left">
                                        <asp:TextBox ID="txtBuild" runat="server" CssClass="form-control" placeholder="" MaxLength="50"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group" style="text-align: left">
                                        <asp:TextBox ID="txtDesc" runat="server" CssClass="form-control" placeholder="" MaxLength="50"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-actions">
                        ...
                        <asp:GridView ID="gvResult" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="BUSINESS AREA" DataField="BA" ItemStyle-HorizontalAlign="Left" SortExpression="BA" />
                                <asp:BoundField HeaderText="PROFIT CENTER" DataField="PROFIT_CTR" ItemStyle-HorizontalAlign="Left" SortExpression="BA" />
