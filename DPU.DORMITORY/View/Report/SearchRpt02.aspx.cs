...
{
    public partial class SearchRpt02 : System.Web.UI.Page
    {
        ...
        {
            SearchResult = objReport.getRpt02(Convert.ToInt32(ddlLang.SelectedValue));
        ...
        //private void print(int _roomId, int _customerId, int _invoiceId, DateTime _date)
        //{
