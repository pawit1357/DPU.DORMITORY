<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="User.aspx.cs" Inherits="DPU.DORMITORY.Web.View.Admin.User" %>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <asp:ListBox ID="lstBuild" runat="server" DataTextField="Name" DataValueField="ID" SelectionMode="Multiple" class="bs-select form-control"></asp:ListBox>
                                </div>
                            </div>
                        </div>
