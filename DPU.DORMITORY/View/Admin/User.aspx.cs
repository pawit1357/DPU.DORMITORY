...
namespace DPU.DORMITORY.Web.View.Admin
{
    public partial class User : System.Web.UI.Page
    {
        ...
        private void initialPage()
        {
            ...
            switch (CommandName)
            {
                ...
                case CommandNameEnum.Edit:
                    ...
                    ddlRole.CssClass = "select2_category form-control";
                    ddlTitle.CssClass = "select2_category form-control";
                ...
                case CommandNameEnum.View:
                    fillinScreen();
                    txtUser.ReadOnly = true;
                    //ddlRole.CssClass = "select2_category form-control disabled";
                    //ddlTitle.CssClass = "select2_category form-control disabled";
        ...
        private void fillinScreen()
        {
            ...
            USER user = repUser.Table.Where(x => x.USER_ID.Equals(this.PKID)).FirstOrDefault();
            if (user != null)
            {
