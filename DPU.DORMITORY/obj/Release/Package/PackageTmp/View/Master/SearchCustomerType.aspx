<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="SearchCustomerType.aspx.cs" Inherits="DPU.DORMITORY.Web.View.Master.SearchCustomerType" %>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box blue-madison">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-cogs"></i>ประเภทลูกค้า
                        </div>
                        <div class="actions">
