<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="SearchRoomType.aspx.cs" Inherits="DPU.DORMITORY.Web.View.Master.SearchRoomType" %>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box blue-madison">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-cogs"></i>ประเภทห้อง
                        </div>
                        <div class="actions">
